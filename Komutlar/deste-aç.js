module.exports = {
  ...
  async run(client, message, args) {
    ...
    var destedencikanlar =
      destedencikanlar[Math.floor(Math.random(1) * destedencikanlar.length)];
    const embed = new Discord.MessageEmbed()
      .setImage(
        "https://s3.eu-central-1.amazonaws.com/images.gamesatis.com/products/images/000/024/678/big/platin-deste.jpg"
      )
      .setDescription(`${destedencikanlar}`)
      .setFooter(
        `Desteyi açan (${message.author.username}) Unutma Bunlar Sadece Bir Simülatör Gerçek hesabına Gelmez`
      )
      .setColor("RANDOM");
